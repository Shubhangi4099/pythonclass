...
setup(
    ...
    url='https://github.com/Shubhangi4099/python/tree/main/newpy',
    download_url='https://github.com/Shubhangi4099/python/tree/main/newpy' + __version__,
    license='MIT',
    classifiers=[
    ...
    author='shubhangi ganbas',
    install_requires=install_requires,
    dependency_links=dependency_links,
    author_email='shubhangiganbas12@gmail.com',
    entry_points={
        'console_scripts': [
